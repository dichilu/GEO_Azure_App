...
1. **AI 內容生成與優化引擎**
   ...
   - 目標優化引擎支援 Standard SEO, Gemini, Claude, ChatGPT, Perplexity；RBU 選 ACN（中國）時自動切換為文心一言、通義千問、DeepSeek、豆包。各引擎的語氣/結構客製化邏輯依2026 GEO/AEO實證研究校正，同時套用於產品文案與SEO/GEO文章生成（廣告文案尚未接入）。
